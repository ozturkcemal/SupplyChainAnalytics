...
# Save to HTML in the same directory as the Python file
# This works on local machines, cloud servers, anywhere
script_dir =    Path(__file__).parent
html_file_path = script_dir / 'optimized_route_map.html'

fmap.save(html_file_path)
print(f"Static route saved to '{html_file_path}'")
